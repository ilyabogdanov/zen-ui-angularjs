...
describe("directive: zen-password-field", function() {
    let element, scope;
    ...
    it("should render", function () {
        inject(function($compile, $rootScope) {
            scope = $rootScope.$new();
            scope.model = null;
            element = "<zen-password-field zen-error=\"::false\" zen-model=\"model\" zen-stretch=\"::false\"></zen-password-field>";
    ...
    describe("with empty attribute \"zen-stretch\"", function () {
        it("should set true", function () {
            inject(function($compile, $rootScope) {
                scope = $rootScope.$new();
                scope.model = null;
                element = "<zen-password-field zen-stretch zen-model=\"model\"></zen-password-field>";
                element = $compile(element)(scope);
                scope.$digest();
                angular.element(div).append(element);
            })
    ...
    describe("without attribute \"zen-stretch\"", function () {
        it("should set false", function () {
            inject(function($compile, $rootScope) {
                scope = $rootScope.$new();
                scope.model = null;
                element = "<zen-password-field zen-model=\"model\"></zen-password-field>";
                element = $compile(element)(scope);
                scope.$digest();
                angular.element(div).append(element);
            })
